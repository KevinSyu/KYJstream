...
@NgModule({
  imports: [MatButtonModule, MatCheckboxModule, MatInputModule, MatAutocompleteModule,
    ...
    MatChipsModule, MatChipsModule, MatIconModule, MatProgressSpinnerModule,
    MatProgressBarModule, MatDialogModule, MatTooltipModule, MatSnackBarModule,
    MatTableModule, MatSortModule, MatPaginatorModule], // 先import
  exports: [MatButtonModule, MatCheckboxModule, MatInputModule, MatAutocompleteModule,
    ...
    MatChipsModule, MatChipsModule, MatIconModule, MatProgressSpinnerModule,
    MatProgressBarModule, MatDialogModule, MatTooltipModule, MatSnackBarModule,
    MatTableModule, MatSortModule, MatPaginatorModule] // 在export
})
